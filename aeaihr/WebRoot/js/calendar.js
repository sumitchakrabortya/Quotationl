...
// $Id: calendar.js,v 1.2 2008/11/23 12:12:23 zhangyu Exp $
...
Calendar.prototype.create = function (_par) {
	...
	//modified by zhang_ji_yu@163.com
	this.title = hh("", title_length-1, 300);
	//this.title = hh("", title_length, 300);
	this.title.className = "title";
	
	/***************************************************************/
	//  added by zhang_ji_yu@163.com
	//  for extending clear target vlaue function
	/****************************************************************/
	var clearCell = hh("清空", 1, 200);
	clearCell.ttip = Calendar._TT["CLEAR"];
	clearCell.style.paddingTop="2px";	
...
Calendar.setup = function (params) {
	...
	param_default("ifFormat",       "%Y-%m-%d %H:%M:00");
	param_default("daFormat",       "%Y-%m-%d %H:%M:00");
...
function initCalendar(inputTagId,format,btnId)
{
	if (format.length==8){
		Calendar.setup({inputField:inputTagId,ifFormat:format,button:btnId})
	}else{
		Calendar.setup({inputField:inputTagId,ifFormat:format,showsTime:true,button:btnId})
	}
}
