...
function showMaskLayer(pOpacity){
	...
	$('#splashLayer').css({"z-index":900,display:'block',opacity:curOpacity});
}
...
function initMaskLayer(){
	...
	$("<div id='messageDiv' style='position: absolute;display:none;left:50%;top:50%;margin-left:-125px;margin-top:-120px;z-index:999;'><table width='250' border='0' align='center' cellpadding='0' cellspacing='1' bordercolor='#FF0000' bgcolor='#000000'><tr bgcolor='#FFFFFF'><td height='60' style='font-size:12px;' id='infoTD' align='center' bordercolor='#1860A8' bgcolor='#DEE8F6'>"+waitMsg+"</td></tr></table></div>").appendTo("body");
}
function ele(id){
