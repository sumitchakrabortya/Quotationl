...
<%if(!pageBean.getBoolValue("hasRight")){%>
 <td onmouseover="onMover(this);" onmouseout="onMout(this);" class="bartdx" align="center" onclick="enableSave()" ><input value="&nbsp;" type="button" class="editImgBtn" id="modifyImgBtn" title="编辑" />编辑</td>
  ...
  <%if(!(pageBean.selectedValue("SAL_STATE")).equals("1")){%>
   <td  align="center"class="bartdx"onclick="stateApprove();" onmouseover="onMover(this);" onmouseout="onMout(this);"  ><input value="&nbsp;"type="button" class="approveImgBtn" id="SAL_STATE"  title="核准" />核准</td>
   <%}else{%>
...
<tr>
	...
	<td><input name="SAL_BASIC" type="text" class="text" id="SAL_BASIC" value="<%=pageBean.inputValue("SAL_BASIC")%>" size="24" readonly="readonly" label="基本工资" />
</td>
</tr>
<tr>
	<th width="100" nowrap>绩效工资</th>
	<td><input name="SAL_PERFORMANCE" type="text" class="text" id="SAL_PERFORMANCE" value="<%=pageBean.inputValue("SAL_PERFORMANCE")%>" size="24" readonly="readonly" label="绩效工资" />
</td>
</tr>
<tr>
	<th width="100" nowrap>补贴</th>
	<td><input name="SAL_SUBSIDY" type="text" class="text" id="SAL_SUBSIDY" value="<%=pageBean.inputValue("SAL_SUBSIDY")%>" size="24" readonly="readonly" label="补贴" />
</td>
</tr>
<tr>
	<th width="100" nowrap>奖金</th>
	<td><input id="SAL_BONUS" label="奖金" name="SAL_BONUS" type="text" class="text markable0" value="<%=pageBean.inputValue("SAL_BONUS")%>" size="24" maxlength="6" <%if(!pageBean.getBoolValue("hasRight")&& pageBean.getBoolValue("isComeFromDetail")){ %> readonly="readonly" <%}%>  />
</td>
</tr>
<tr>
	<th width="100" nowrap>保险</th>
	<td><input name="SAL_INSURE" type="text" class="text" id="SAL_INSURE" value="<%=pageBean.inputValue("SAL_INSURE")%>" size="24" readonly="readonly" label="绩效工资" />
</td>
</tr>

<tr>
	<th width="100" nowrap>个人所得税</th>
	<td><input name="SAL_TAX" type="text" class="text" id="SAL_TAX" value="<%=pageBean.inputValue("SAL_TAX")%>" size="24" readonly="readonly" label="绩效工资" />
</td>
</tr>
<tr>
...
<tr>
	...
	<td><input name="SAL_ACTUAL" type="text" class="text markable" id="SAL_ACTUAL" value="<%=pageBean.inputValue("SAL_ACTUAL")%>" size="24" readonly="readonly" label="补贴" />
</td>
</tr>
<tr>
