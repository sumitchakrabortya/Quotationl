...
<input id="userId" name="userId" class="required" tabindex="1" accesskey="n" type="text" value="" size="25" autocomplete="off">
<label for="userPwd">密 &nbsp;&nbsp;码：</label>
<input id="userPwd" name="userPwd" class="required" onkeydown="keyDownLogin(event)" tabindex="2" accesskey="p" type="password" value="" size="25" autocomplete="off">
<label for="valideCode">验证码：</label>
<input id="valideCode" name="valideCode" class="required" onkeydown="keyDownLogin(event)" tabindex="2" accesskey="y" type="text" value="" size="30" maxlength="16" autocomplete="off">
