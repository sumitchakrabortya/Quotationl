...
<tr>
   ...
   <td onmouseover="onMover(this);" onmouseout="onMout(this);" class="bartdx" hotKey="C" align="center" onclick="refreshPage()"><input value="&nbsp;" title="刷新" type="button" class="refreshImgBtn" />刷新</td>
...
<div style="margin:2px;height:230px;overflow-y:auto;">
