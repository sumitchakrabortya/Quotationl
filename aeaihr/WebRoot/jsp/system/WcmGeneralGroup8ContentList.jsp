...
<tr>
	<td valign="top">
    <div id="leftTree" class="sharp color2" style="margin-top:3px;">
...
<%}%>    
    <div id="treeArea" style="overflow:auto; height:300px;width:230px;background-color:#F9F9F9;padding-top:3px;padding-left:5px;">
...
height="373px"
>
<ec:row styleClass="odd" ondblclick="openContentRequestBox('detail','资源列表','WcmGeneralResourceEdit','RES_ID')" oncontextmenu="selectRow(this,{RES_ID:'${row.RES_ID}',curColumnId:'${row.RES_ID}'});refreshConextmenu()" onclick="selectRow(this,{RES_ID:'${row.RES_ID}',curColumnId:'${row.RES_ID}'})">
...
$(window).load(function() {
	setTimeout(function(){
		<% if (!pageBean.isValid(pageBean.inputValue("rootColumnId"))){%>		
		resetTreeHeight(100);
		resetRightAreaHeight(84);
		<%}else{%> 
		resetTreeHeight(70);
		resetRightAreaHeight(54);
		<%}%> 
	},1);	
});
</script>
