...
function doChangeParent(){
	if($('#ROLE_TYPE').val()=="menu"){
		writeErrorMsg("不能迁移目录!")
		selectOrFocus($('#ROLE_ID').val());
		return ;
	}else{
...
<tr>
	...
	<td><input id="ROLE_CODE" label="编码" name="ROLE_CODE" type="text" readOnly="readonly" value="<%=pageBean.inputValue("ROLE_CODE")%>" size="24" class="text" />
</td>
</tr>
<tr>
...
<tr>
	<th width="100" nowrap>类别</th>
	<td><input id="ROLE_TYPE_TEXT" label="类别" class="text markable" name="ROLE_TYPE_TEXT" type="text" readOnly="readonly" value="<%=pageBean.selectedText("ROLE_TYPE")%>" size="24" class="text"/> 
<input id="ROLE_TYPE" label="类别" name="ROLE_TYPE" type="hidden" value="<%=pageBean.selectedValue("ROLE_TYPE")%>" />
</td>
</tr>
<tr>
...
<tr>
	...
	<span name="validatespanNameOfStar" class="validate_required_star">*</span>
</td>
</tr>
<tr>
	<th width="100" nowrap>名称</th>
...
<tr>
	<th width="100" nowrap>类别</th>
	<td>&nbsp;<%=pageBean.selectRadio("CHILD_ROLE_TYPE")%></td>
</tr>
<tr>
	<th width="100" nowrap>状态</th>
