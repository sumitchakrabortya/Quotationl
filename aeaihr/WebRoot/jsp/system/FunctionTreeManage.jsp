...
<div class="photobox newarticlebox" id="Layer0" style="height:427px;">
	<div style="padding:0 5px 5px 5px;margin-top: 2px">
	    ...
	    <table class="detailTable" cellspacing="0" cellpadding="0">
			...
			<%}%>
			<tr>
				<th width="100" nowrap="">菜单图标</th>
				<td><input id="FUNC_ICON" label="菜单图标" name="FUNC_ICON" type="text" value="<%=pageBean.inputValue("FUNC_ICON")%>" size="32" class="text"><a href="<%=request.getContextPath()%>/html/icons.html" target="_blank">参考图标</a></td>			
			</tr>
			<tr>
