...
height="300px"
>
<ec:row styleClass="odd" ondblclick="doRequest('viewDetail')" oncontextmenu="selectRow(this,{HANLER_ID:'${row.HANLER_ID}'});refreshConextmenu()" onclick="selectRow(this,{HANLER_ID:'${row.HANLER_ID}'})">
...
<input type="hidden" name="FUNC_ID" id="FUNC_ID" value="<%=pageBean.inputValue("FUNC_ID")%>" />
