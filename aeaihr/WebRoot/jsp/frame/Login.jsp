...
<div id="top">
    <div id="main">
        <div id="login-form">
			...
			<span>
			<input id="valideCode" style="width:121px;" label="验证码" name="valideCode" class="required" onkeydown="keyDownLogin(event)" tabindex="2" accesskey="y" type="text" value="" size="30" maxlength="16" autocomplete="off">
