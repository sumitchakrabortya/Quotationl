...
<div id="top">
    <div id="main">
        <div id="login-form">
			...
			<p class="label">
			<span class="tlabel"><%=resourceBundle.getString("Login.userName")%></span>
			<input id="userId" label="<%=resourceBundle.getString("Login.userName")%>" name="userId" class="required" tabindex="1" accesskey="n" type="text" value="" size="25" autocomplete="off">
			</p>
			<p class="label">
			<span class="tlabel"><%=resourceBundle.getString("Login.userPassword")%></span>
			<input id="userPwd" label="<%=resourceBundle.getString("Login.userPassword")%>" name="userPwd" class="required" onkeydown="keyDownLogin(event)" tabindex="2" accesskey="p" type="password" value="" size="25" autocomplete="off">
			</p>
			<p class="label">
			<span class="tlabel"><%=resourceBundle.getString("Login.valideCode")%></span>
			<span>
			<input id="valideCode" style="width:121px;" label="<%=resourceBundle.getString("Login.valideCode")%>" name="valideCode" class="required" onkeydown="keyDownLogin(event)" tabindex="2" accesskey="y" type="text" value="" size="30" maxlength="16" autocomplete="off">
			...
			<input class="btn-submit" name="button" accesskey="l" value="<%=resourceBundle.getString("Login.login")%>" tabindex="4" type="button" onClick="doSubmit()">
			<input class="btn-reset" name="reset" accesskey="c" value="<%=resourceBundle.getString("Login.reset")%>" tabindex="5" type="reset">
			</p>
	...
	<div id="bottom">
	    <div id="bottom-content" style="color:#FFF;">建议使用IE8以上版本的浏览器，1024*768以上分辨率 </div>
	</div>
</div>
</body>
</html>
