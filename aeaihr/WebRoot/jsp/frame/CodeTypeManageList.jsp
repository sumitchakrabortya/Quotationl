...
>
<ec:row styleClass="odd" onclick="controlButton(this,'${row.TYPE_ID}','${row.IS_UNITEADMIN}')" oncontextmenu="controlButton(this,'${row.TYPE_ID}','${row.IS_UNITEADMIN}');refreshConextmenu()" ondblclick="doRequest('viewDetail')">
