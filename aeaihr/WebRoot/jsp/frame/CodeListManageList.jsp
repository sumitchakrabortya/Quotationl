...
<div id="__ParamBar__">
<%if ("byType".equals(pageBean.inputValue("manageType"))){%>
<input type="hidden" name="TYPE_ID" id="TYPE_ID" value="<%=pageBean.inputValue("TYPE_ID")%>" />
<%}else{%>
<table class="queryTable">
<tr><td>
<%if ("normal".equals(pageBean.inputValue("manageType")) || "byGroup".equals(pageBean.inputValue("manageType"))){%>
...
sortable="true" 
height="390px" 
rowsDisplayed="${ec_rd == null ?15:ec_rd}"
excludeParameters="actionType"
>
<ec:row styleClass="odd" onclick="controlButton(this,{CODE_ID:'${row.CODE_ID}',CODE_TYPE_ID:'${row.TYPE_ID}'},'${row.IS_EDITABLE}')" oncontextmenu="controlButton(this,{CODE_ID:'${row.CODE_ID}',CODE_TYPE_ID:'${row.TYPE_ID}'},'${row.IS_EDITABLE}');refreshConextmenu()" ondblclick="doRequest('viewDetail')">
