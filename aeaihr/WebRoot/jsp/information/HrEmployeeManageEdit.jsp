...
<tr>
	...
	<td><input id="EMP_CODE" label="编号" name="EMP_CODE" type="text" value="<%=pageBean.inputValue("EMP_CODE")%>" <%if("readonly".equals(pageBean.getAttribute("onlyRead"))){ %>readonly="readonly"<%} %> <%if("codereadonly".equals(pageBean.getAttribute("codeReadonly"))){ %>readonly="readonly"<%} %> size="24" class="text" />
</td>
...
<th width="100" nowrap>个人所得税</th>
	<td><input name="EMP_TAX" type="text" class="text markable0" id="EMP_TAX" value="<%=pageBean.inputValue("EMP_TAX")%>" size="24"  label="个人所得税" />
</td>
</tr>
<tr>
