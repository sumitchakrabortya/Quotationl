...
public class SystemLogQueryImpl extends QueryModelServiceImpl implements
	...
	public PageList<DataRow> findRecords(DataParam param) {
		...
		param.put("_startNum4Mysql_",(startNum-1));
		param.put("_endNum4Mysql_",endNum);
		param.put("_stepRange4Mysql_",(endNum-startNum+1));
		
		param.put("_startNum4Orcl_",startNum);
		param.put("_endNum4Orcl_",endNum);
		
		param.put("_startNum4Sqlserver_",startNum);
		param.put("_endNum4Sqlserver_",endNum);
